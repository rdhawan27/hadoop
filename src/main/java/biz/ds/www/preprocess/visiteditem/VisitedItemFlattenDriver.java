...
public class VisitedItemFlattenDriver  extends Configured implements Tool {
	...
	private static final Log LOG = LogFactory.getLog(VisitedItemFlattenDriver.class);
	...
	public int run(String[] args)  throws Exception{
		...
		job.setMapperClass(VisitedItemFlattenMapper.class);
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new VisitedItemFlattenDriver(), args);
