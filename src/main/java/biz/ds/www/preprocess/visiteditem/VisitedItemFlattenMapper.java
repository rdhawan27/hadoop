...
public class VisitedItemFlattenMapper extends Mapper<LongWritable, Text, UserWritable, Text>{

	private static final Log LOG = LogFactory.getLog(VisitedItemFlattenMapper.class);

	private VistedItemFlattenMapperParser parser = new VistedItemFlattenMapperParser();
